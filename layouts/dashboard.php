	...
	<aside>
		...
		<nav>
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/transaksip">
						<img class="icon" src="<?php echo AST; ?>/img/menu.png" alt=""> Transaksi
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo URL; ?>/games">
						<img class="icon" src="<?php echo AST; ?>/img/menu.png" alt=""> Games
					</a>
				</li>
				<li>
				<li>
					<a href="<?php echo URL; ?>/lesson">
						<img class="icon" src="<?php echo AST; ?>/img/menu.png" alt=""> Lesson
					</a>
				</li>
				<li>
